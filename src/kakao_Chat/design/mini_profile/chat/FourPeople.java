...
public class FourPeople extends MiniProfileDesign_Chat{
	...
	public void miniProfileMakeByNumber(JPanel chattingPanel) {
		JButton profileButton_1 = new RoundedButton("",new ImageIcon("img/defaultProfile45.png"));
		profileButton_1.setBounds(22, 5, 34, 33);
		profileButton_1.setBackground(Color.white);
		chattingPanel.add(profileButton_1);
		
		JButton profileButton_1_1_1 = new RoundedButton("",new ImageIcon("img/defaultProfile45.png"));
		...
		JButton profileButton_1_1 = new RoundedButton("",new ImageIcon("img/defaultProfile45.png"));
